...
export const apunteUpdateValidation = joi.object({
    ...
    estado: joi.string()
        .trim()
        .valid('Activo', 'Bajo Revisión', 'Suspendido')
        .messages({
            "string.base": "El estado debe ser de tipo string.",
            "any.only": "El estado debe ser uno de los siguientes: Activo, Bajo Revisión, Suspendido.",
        }),
})
    .or("nombre", "descripcion", "asignatura", "fechaSubida", "tipoApunte", "valoracion", "visualizacion", "estado")
    .unknown(false)
    .messages({
        'object.unknown': 'No se permiten propiedades adicionales en el cuerpo de la solicitud',
        'object.missing': 'Debe proporcionar al menos uno de los campos: nombre, descripcion, asignatura, fechaSubida, tipoApunte, valoracion, visualizacion o estado',
    });
...
export const valoracionDeleteValidation = joi.object({
    rutUserValoracion: joi.string()
        .required()
        .min(9)
        .max(12)
