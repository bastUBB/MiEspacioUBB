...
import { crearPerfilAcademicoAyudanteService, poseePerfilAcademicoService } from '../../services/perfilAcademico.service';

function InicioPerfilAcademicoAyudante() {
            ...
            if (!userLoading && user && !hasCheckedProfile.current) {
                ...
                try {
                    ...
                    if (response.data && response.data._id) {
                        ...
                        navigate('/ayudante/home', { replace: true });
                        return;
                    } else {
                        setHasProfile(false);
                    }
    ...
    const createProfile = async () => {
        try {
            ...
            if (informeCurricular.length === 0) {
                toast.error('Debes completar al menos las notas o la complejidad de una asignatura cursante');
                return;
            }
...
export default InicioPerfilAcademicoAyudante;
